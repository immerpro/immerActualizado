...
//        $idProducto = $this->uri->segment(3);
    ...
    public function pagina($numPag = 0) {
        ...
        if ($listadoCategoria) {
            ...
            foreach ($listadoCategoria as $categoria_item) {
                $this->table->add_row(
                        $categoria_item->NombreCategoria, $categoria_item->detalles, 'Mira <a class="orange-text" href=' . base_url() . 'CategoriaController/Ver/' . $categoria_item->idCategoria . ' ><i class="fa fa-eye" onmouseover="Subcategoria"></i></a>' .
                        ' Agrega <a class="teal-text" href=' . base_url() . 'CategoriaController/Agregar/' . $categoria_item->idCategoria . '><i class="fa fa-plus"></i></a>', 'Modificar <a class="teal-text" href=' . base_url() . 'CategoriaController/editar/' . $categoria_item->idCategoria . '><i class="fa fa-pencil "></i></a>'
                        .'Inactivar <a class="red-text" href=' . base_url() . 'CategoriaController/modal/' . $categoria_item->idCategoria . '><i class="fa fa-times" ></i></a>');
    ...
    public function InCategoria() {
        ...
        $data['mrol'] = $this->usuario_model->mostrarRol($this->session->userdata('rol'));
...
// vista para agregar la subcategoria
    public function Agregar() {
       ...
       $this->load->view('templates/admin/headerAdmin', $agr);
        $this->load->view('templates/admin/menuV');
        $this->load->view('templates/admin/menuH', $agr);
    ...
    public function editar() {
        ...
        $dato['mrol'] = $this->usuario_model->mostrarRol($this->session->userdata('rol'));
