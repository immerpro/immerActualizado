...
//        $data['subcategorias'] = $this->subcategoria_model->obtenerSubCategorias();
        ...
        if ($this->form_validation->run() === FALSE) {
            $this->load->view('templates/admin/headerAdmin', $t);
            $this->load->view('templates/admin/menuV');
            $this->load->view('templates/admin/menuH', $t);
    ...
    public function index($numPag = 0) {
        ...
        $this->load->view('templates/admin/headerAdmin', $info);
        $this->load->view('templates/admin/menuV');
        $this->load->view('templates/admin/menuH', $info);
